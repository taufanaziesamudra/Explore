...
const path = require('path') // Memanggil Path (express static)
...
app.use('/images', express.static(path.join(__dirname, 'images'))) // Middleware untuk mengatasi pemanggilan image
