...
export class CardProduct extends Component {
    ...
    // Method untuk menerima newValue
    handleCounterChange = (newValue) => {
        // Menerima props dari product dengan nama counterChange
        this.props.counterChange(newValue)
    }
    ...
    handlePlus = () => {
        this.setState({
            ...
            // Ketika handlePlus dipanggil maka akan memanggil handleCounterChange
            // yang akan dikirimkan state terbaru berupa newValue yang tingkap di counterChange
    ...
    hanldeMinus = () => {
        if (this.state.order > 0) {
            this.setState({
                ...
                // Ketika handleMinus dipanggil maka akan memanggil handleCounterChange
                // yang akan dikirimkan state terbaru berupa newValue yang tingkap di counterChange
                this.handleCounterChange(this.state.order)
            })
        }
            ...
            <div>
                <div className="card">
                    ...
                    <div className="counter">
                        ...
                        {/* Meneriman Method dari handlePlus */}
